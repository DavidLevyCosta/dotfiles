      ...
      <div className="register-card">
        ...
        <form className="register-form">
          <div className="form-group two-thirds">
            <input type="text" value={values.nome} onChange={onChange} id="fullName" name="fullName" placeholder="Nome Completo" required />
          </div>
          <div className="form-group one-third">
            <input type="text" value={values.cpf} id="cpf" name="cpf" placeholder="CPF" required />
          </div>
