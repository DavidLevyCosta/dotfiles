...
CREATE TABLE trocas_materiais(
    ...
    trm_QUANTIDADE FLOAT(10,2) NOT NULL,
...
CREATE TABLE trocas_seeds(
    ...
    trs_quantidade FLOAT(10,2) NOT NULL,
...
;-- -. . -..- - / . -. - .-. -.--
ALTER TABLE users MODIFY usr_saldo DECIMAL(10,2) NOT NULL;
;-- -. . -..- - / . -. - .-. -.--
drop database RECYCL;
;-- -. . -..- - / . -. - .-. -.--
